...
session_start();
$status="CHECK IN";
if(isset($_SESSION['loggedin']) AND $_SESSION['id']==="admin"){
    header("location:index.php");

} $spid=$_SESSION['empcode'];
require_once"top.php";

$sl="SELECT * FROM orders JOIN employees   on employees.id = orders.salespersonid JOIN parties on orders.partyid=parties.partyid and orders.salespersonid ='$spid' ORDER BY orderid DESC ";
...
$parresult=mysqli_query($con,"SELECT * FROM parties where salespid=$spid");
$count_par=mysqli_num_rows ( $parresult );
$fetch="SELECT * FROM collections join parties on parties.partyid=collections.partyid join employees on employees.id=collections.salespid and collections.mode='cash' and collections.salespid='$spid' ORDER BY cid DESC";
// echo $fetch;
// die();
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Salesman Dashboard</h1>
      </div>
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
