...
$fetch="SELECT * FROM collections join parties on parties.partyid=collections.partyid join employees on employees.id=collections.salespid and collections.mode='cash' and collections.salespid=$empcode ORDER BY cid DESC";
}
else{
