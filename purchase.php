...
if (isset($_POST["create_invoice"])) {
  ...
  extract($_POST);
  //purid	invno	sid	date	order_total_before_tax	order_total_tax1	order_total_tax2	order_total_tax	order_total_after_tax	status	ordernote

  $sql_insert = "INSERT INTO `porders`(`sid`, `invno`, `order_total_before_tax`, `order_total_tax1`, `order_total_tax2`,`order_total_tax`, `order_total_after_tax`)
     VALUES ('$partyname','$invno','$order_total_before_tax',
  ...
  for ($i = 0; $i < $service; $i++) {
    ...
    $k="update products set stock=stock + '$order_item_quantity[$i]' where productid='$productname[$i]'";
    mysqli_query($con,$k);
              ...
              <table class="table table-bordered">
                <tr>
                  <td colspan="2" align="center">
                    <h2 style="margin-top:10.5px">Purchase Invoice</h2>
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
                    <div class="row">
                          ...
                          <div class="form-group " id="alertDesignation">
                            ...
                            <select name="partyname" id="partyname" class="form-control select2bs4">
                              ...
                              while ($party = mysqli_fetch_array($pdetails)) {
                                ...
                                echo "<option value='" . $party['sid'] . "'>" . $party['companyname'] . "</option>";
                              }
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="invno" class="form-control" id="" placeholder="" value="">
                        </div>    
                      </div>
                    </div>
                    <br />
