...
// }
    ...
    $fetch="SELECT * FROM orders JOIN employees   on employees.id = orders.salespersonid JOIN parties on orders.partyid=parties.partyid  and orders.date ='$curdate' ORDER BY orders.orderid DESC";
