...
if(isset($_POST["create_invoice"]))
  {
    ...
    $delbal="update parties set bal= bal-'$odrfinal' where partyid='$partyname'";
 
    mysqli_query($con,$delbal);
    ...
    //  die();
     ...
     $updbal="update parties set bal= bal +'$order_total_after_tax' where partyid='$partyname'";
